...
//
// Created: 13 Feb 2019 (from da6_test_main.cpp)
// Updated: 13 Feb 2019
//
// For CS 372 Spring 2019
// Tests for CS 372 in class TDD Kata: main program.
// Uses the "Catch" unit-testing framework, version 2
// Requires are defined in catch_test_suites.cpp.
...
int main(int argc,
         char *argv[])
{
    const std::string tname = "CS 372 TDD Kata";
